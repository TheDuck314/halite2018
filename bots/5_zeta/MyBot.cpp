...
void plan_mining(const vector<Ship> &miners)
{
    ...
    //Log::log("Constants::INSPIRATION_RADIUS = %d", Constants::INSPIRATION_RADIUS);
    //Log::log("Constants::INSPIRATION_SHIP_COUNT = %d", Constants::INSPIRATION_SHIP_COUNT);
    //Log::log("Constants::INSPIRED_BONUS_MULTIPLIER = %f", Constants::INSPIRED_BONUS_MULTIPLIER);
    //Log::log("Constants::INSPIRED_EXTRACT_RATIO = %f", Constants::INSPIRED_EXTRACT_RATIO);
